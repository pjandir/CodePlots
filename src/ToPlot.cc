...
TString ToPlot::getCommonName(TString name) {
  ...
  else if ( name.Contains("@Jets->at(0).Pt()") ) ret = "jetpt1";
  else if ( name.Contains("@Jets->at(1).Pt()") ) ret = "jetpt2";
  else if ( name.Contains("@Jets->at(2).Pt()") ) ret = "jetpt3";
  else if ( name.Contains("@Jets->at(3).Pt()") ) ret = "jetpt4";
  else if ( name.Contains("@Jets->at(4).Pt()") ) ret = "jetpt5";
  else if ( name.Contains("@Jets->at(5).Pt()") ) ret = "jetpt6";
  else if ( name.Contains("@Jets->at(0).Phi()") ) ret = "jetphi1";
  else if ( name.Contains("@Jets->at(1).Phi()") ) ret = "jetphi2";
  else if ( name.Contains("@Jets->at(2).Phi()") ) ret = "jetphi3";
  else if ( name.Contains("@Jets->at(3).Phi()") ) ret = "jetphi4";
  else if ( name.Contains("@Jets->at(4).Phi()") ) ret = "jetphi5";
  else if ( name.Contains("@Jets->at(5).Phi()") ) ret = "jetphi6";
  else if ( name.Contains("@Jets->at(0).Eta()") ) ret = "jeteta1";
  else if ( name.Contains("@Jets->at(1).Eta()") ) ret = "jeteta2";
  else if ( name.Contains("@Jets->at(2).Eta()") ) ret = "jeteta3";
  else if ( name.Contains("@Jets->at(3).Eta()") ) ret = "jeteta4";
  else if ( name.Contains("@Jets->at(4).Eta()") ) ret = "jeteta5";
  else if ( name.Contains("@Jets->at(5).Eta()") ) ret = "jeteta6";
  else ret = name;
